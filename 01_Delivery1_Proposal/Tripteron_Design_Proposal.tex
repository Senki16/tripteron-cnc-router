...
\includegraphics[height=3.7cm,keepaspectratio]{figures/concept_riano.png}\\[4pt]{\small Germ\'an Ria\~no}
\end{minipage}\hfill
\begin{minipage}[t]{0.32\textwidth}\centering
\includegraphics[height=3.7cm,keepaspectratio]{figures/concept_zuluaga.png}\\[4pt]{\small David Zuluaga Henao}
\end{minipage}\hfill
\begin{minipage}[t]{0.32\textwidth}\centering
\includegraphics[height=3.7cm,keepaspectratio]{figures/concept_amell.png}\\[4pt]{\small David Amell Osorio}
\end{minipage}
\caption{Individual concepts.}
\end{figure}
...
The machine is developed collaboratively: the drawing package is produced jointly, and the
construction of the enclosure, structure and mechanism is split among specialised
sub-groups whose work is integrated at the end. The team meets weekly to agree on the next
tasks and to report on the ones already completed.

\begin{center}
\begin{tabular}{@{}llll@{}}
\toprule
\textbf{Milestone} & \textbf{Delivery} & \textbf{Content} \\
\midrule
1 & Delivery 1 & Concept, requirements, PDS, architecture selection \\
2 & Delivery 2 & Complete drawing package and bill of materials \\
3 & Delivery 3 & Calculation report: kinematics, statics, transmission, FEA \\
4 & Final      & Manufactured and assembled machine \\
\bottomrule
\end{tabular}
\end{center}
...
8 & Repeated figures and an unattributed image taken from the internet
  ...
  & Duplicates removed; only the team's own material is reproduced \\
\bottomrule
\end{tabular}
\end{center}
