...
\includegraphics[width=\textwidth]{figures/concept_riano.png}\\{\small Germ\'an Ria\~no}
\end{minipage}\hfill
\begin{minipage}{0.32\textwidth}\centering
\includegraphics[width=\textwidth]{figures/concept_zuluaga.png}\\{\small David Zuluaga Henao}
\end{minipage}\hfill
\begin{minipage}{0.32\textwidth}\centering
\includegraphics[width=\textwidth]{figures/concept_amell.png}\\{\small David Amell Osorio}
\end{minipage}
